...
public class CollaboratorMcpTool {

    private final McpToolService mcpToolService;

    @Tool(name = "search_collaborators", description = "Busca colaboradores en OrionCode con filtros y paginacion")
    public Map<String, Object> searchCollaborators(
            @ToolParam(description = "Campo a filtrar: firstName, lastName, teamId, positionId o id") String filter,
        ...
        return mcpToolService.searchCollaborators(arguments);
    }
}
