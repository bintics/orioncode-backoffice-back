...
public class TeamMcpTool {

    private final McpToolService mcpToolService;

    @Tool(name = "search_teams", description = "Busca equipos en OrionCode con filtros y paginacion")
    public Map<String, Object> searchTeams(
        ...
        return mcpToolService.searchTeams(arguments);
    }
}
