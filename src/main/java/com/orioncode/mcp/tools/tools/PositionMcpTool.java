...
public class PositionMcpTool {

    private final McpToolService mcpToolService;

    @Tool(name = "search_positions", description = "Busca puestos en OrionCode con filtros y paginacion")
    public Map<String, Object> searchPositions(
            @ToolParam(description = "Campo a filtrar: name, description o id") String filter,
        ...
        return mcpToolService.searchPositions(arguments);
    }
}
